  ...
  return (
    <Grid container sx={{ backgroundColor: '#e8fbff', padding: '70px 20px' }}>
      <Grid item xs={12} md={6} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', fontWeight: 700, position: 'relative' }}>
        <Typography className='verifiedheadone' variant="h4" gutterBottom sx={{ textAlign: 'center', marginBottom: '20px',fontSize:'28px' }}>
          Let Suppliers find you
        </Typography>
        <div  className='verifiedline'style={{ width: '20%', height: '3px', backgroundColor: 'orange', position: 'absolute', bottom: '5px', left: '55%' }}></div>
      </Grid>
